...
**0 of 102 dose entries live.** 34 are complete and waiting only on a signature; 68 still need content. 32 drugs.
...
|---|---|---|---|---|---|
| 1 | ketamine | 23 | 0 / 16 | 4 | traffic |
| 2 | epinephrine | 19 | 0 / 13 | 9 | traffic |
| 3 | rocuronium | 17 | 0 / 4 | 0 | traffic |
| 4 | succinylcholine | 16 | 0 / 5 | 0 | traffic |
...
- group `ketamine-analgesia`
  ...
  - **ketamine · background pain — low-dose analgesia (prolonged field care) · IV** — 0.1 mg/kg (tier 1/1/1)
- group `ketamine-rsi-induction`
  - **ketamine · RSI induction · IV** — 1.5 mg/kg, lesser of 2 mg/kg and 200 mg (tier 0/1)
  - **ketamine · RSI induction · IV** — 2.0 mg/kg (tier 1/1)
  - **ketamine · RSI induction — haemodynamically unstable / in extremis · IV** — 1.0 mg/kg (tier 1/1)
- group `ketamine-rsi-induction-peds`
  - **ketamine · RSI induction · IV** — 1.5 mg/kg, 2 mg/kg, no absolute cap (tier 0/1)
  - **ketamine · RSI induction · IV** — 2.0 mg/kg (tier 1/1)
...
- group `rocuronium-rsi`
  - **rocuronium · RSI paralytic · IV** — 1.0 mg/kg, 1.2 mg/kg (tier 1/1/0)
  - **rocuronium · RSI paralytic · IV** — 1.2 mg/kg (tier 1)
  - **rocuronium · RSI paralytic · IV** — 1.0 mg/kg (tier 1)
- group `succinylcholine-rsi-adult`
  - **succinylcholine · RSI paralytic · IV** — 1.5 mg/kg (tier 1/1/0)
  - **succinylcholine · RSI paralytic · IV** — 1.0 mg/kg (tier 1)
- group `succinylcholine-rsi-peds`
  - **succinylcholine · RSI paralytic · IV** — 2.0 mg/kg (tier 1/0)
  - **succinylcholine · RSI paralytic — under 5 years · IV** — 2.0 mg/kg (tier 1)
  - **succinylcholine · RSI paralytic · IV** — 1.5 mg/kg (tier 1)
...
**0 of 16 entries live, 4 ready to sign.** class: dissociative anaesthetic / analgesic · routes: IV, IO, IM
...
- **flags:** `MIGRATED_UNSOURCED`, `CONCENTRATION_MISMATCH`, `SOURCE_CONFLICT`
  ...
  - **conflicts with:** ketamine · dissociative analgesia (IM — no IV access) · IM; ketamine · moderate to severe pain / analgesia · IV; ketamine · background pain — low-dose analgesia (prolonged field care) · IV (group `ketamine-analgesia`)
...
- **flags:** `MIGRATED_UNSOURCED`, `CONCENTRATION_MISMATCH`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · subdissociative analgesia · IV; ketamine · moderate to severe pain / analgesia · IV; ketamine · background pain — low-dose analgesia (prolonged field care) · IV (group `ketamine-analgesia`)
  - ⚠️ **CONCENTRATION MISMATCH** between the migrated calculator and the WHO-listed strength. A wrong concentration is a wrong volume at the syringe — resolve before signing.
  - ⚠️ **MIGRATED, UNSOURCED.** Value carried over verbatim from the pre-contract hardcode. The engine will NOT let this be signed until a tier 1 or tier 2 citation is attached.
...
- **status:** ⬜ not live — signoff is not true
- **flags:** `CONTRAINDICATION_CONFLICT`, `MIGRATED_UNSOURCED`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · RSI induction · IV; ketamine · RSI induction — haemodynamically unstable / in extremis · IV (group `ketamine-rsi-induction`)
  - ⚠️ **MIGRATED, UNSOURCED.** Value carried over verbatim from the pre-contract hardcode. The engine will NOT let this be signed until a tier 1 or tier 2 citation is attached.
- **dose_range:** `1.5 mg/kg` (per kg)
- **max_single:** `lesser of 2 mg/kg and 200 mg`
- **max_cumulative:** none stated by the cited source
- **contraindications:** Hypersensitivity
- **contraindications:** RELATIVE/CONTROVERSIAL per NASEMSO Appendix III: head trauma, intracranial mass or haemorrhage, hypertension, angina, stroke, underlying psychiatric disorder
- **cautions:** Give BEFORE the paralytic. Confirm weight and route.
- **cautions:** The cited guideline states no cumulative maximum for this drug and indication. That is meaningful silence, not a gap in extraction: the same guideline DOES state cumulative maxima where it means to (ketamine 100 mg, hydromorphone 4 mg, Pain Management p.94).
- **cautions:** SOURCES DISAGREE ON HEAD INJURY. NASEMSO Appendix III lists head trauma and intracranial mass/haemorrhage as relative/controversial contraindications to ketamine; JTS ID61 states plainly that ketamine IS SAFE for use in TBI and/or eye injury. Both are tier 1. This matters for RSI on a head-injured casualty, which is what the discovery run's 'RSI doses, he has a head injury' scenario asks for. Not resolved here.
...
- **why no value was written:** Migrated hardcode, 1.5 mg/kg. NOW CONFLICTS WITH TWO TIER-1 VALUES, which also disagree with each other: JTS ID39 (2026) gives ketamine 2 mg/kg IV/IO as first-line RSI induction, and JTS ID40 (2021) gives 1 mg/kg for the trauma patient in extremis. All three entries are kept. Nothing was picked.
...
- **flags:** `CONTRAINDICATION_CONFLICT`, `MIGRATED_UNSOURCED`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · RSI induction · IV (group `ketamine-rsi-induction-peds`)
  - ⚠️ **MIGRATED, UNSOURCED.** Value carried over verbatim from the pre-contract hardcode. The engine will NOT let this be signed until a tier 1 or tier 2 citation is attached.
- **dose_range:** `1.5 mg/kg` (per kg)
...
- **source:** tier 0 (migration — NOT an approved source) — EdgeCDSS pre-contract hardcoded calculator: ketamine_induction_iv_1.5mgkg · retrieved 2026-08-24
- **source:** tier 1 (NASEMSO) — NASEMSO National Model EMS Clinical Guidelines v3.0 (March 2022) — Appendix III. Medications, p.386 (NASEMSO states this appendix's class/contraindication content derives from medscape.com, accessed 2021-10-23) · retrieved 2026-08-24
- **why no value was written:** Migrated hardcode, 1.5 mg/kg with no absolute cap. JTS ID39 gives 2 mg/kg for paediatric induction, same as adult.
...
- **flags:** `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · subdissociative analgesia · IV; ketamine · dissociative analgesia (IM — no IV access) · IM; ketamine · background pain — low-dose analgesia (prolonged field care) · IV (group `ketamine-analgesia`)
...
#### 12. RSI induction · adult · IV

- **status:** ⬜ not live — signoff is not true
- **flags:** `CONTRAINDICATION_CONFLICT`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · RSI induction · IV; ketamine · RSI induction — haemodynamically unstable / in extremis · IV (group `ketamine-rsi-induction`)
- **dose_range:** `2.0 mg/kg` (per kg)
- **max_single:** none stated by the cited source
...
#### 13. RSI induction — haemodynamically unstable / in extremis · adult · IV

- **status:** ⬜ not live — signoff is not true
- **flags:** `CONTRAINDICATION_CONFLICT`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · RSI induction · IV; ketamine · RSI induction · IV (group `ketamine-rsi-induction`)
- **dose_range:** `1.0 mg/kg` (per kg)
- **max_single:** none stated by the cited source
- **max_cumulative:** none stated by the cited source
- **contraindications:** Hypersensitivity
...
- **cautions:** JTS ID39: ALWAYS SEDATE PRIOR TO PARALYZING.
- **cautions:** JTS ID39: unstable patients require a reduced dosage of induction agent.
- **cautions:** JTS ID40: standard induction dosages should be REDUCED and titrated to balance induction against haemodynamic change.
...
#### 15. ongoing sedation — loading dose · adult|peds · IV
...
#### 16. background pain — low-dose analgesia (prolonged field care) · adult · IV

- **status:** ⬜ not live — signoff is not true
- **flags:** `CONTRAINDICATION_CONFLICT`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** ketamine · subdissociative analgesia · IV; ketamine · dissociative analgesia (IM — no IV access) · IM; ketamine · moderate to severe pain / analgesia · IV (group `ketamine-analgesia`)
...
**0 of 4 entries live, 0 ready to sign.** class: non-depolarising neuromuscular blocker · routes: IV, IO
...
- **status:** ⬜ not live — signoff is not true
- **flags:** `MIGRATED_UNSOURCED`, `NOT_ON_WHO_EML`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** rocuronium · RSI paralytic · IV; rocuronium · RSI paralytic · IV (group `rocuronium-rsi`)
  - ⚠️ **MIGRATED, UNSOURCED.** Value carried over verbatim from the pre-contract hardcode. The engine will NOT let this be signed until a tier 1 or tier 2 citation is attached.
- **dose_range:** `1.0 mg/kg` (per kg)
- **max_single:** `1.2 mg/kg`
- **max_cumulative:** none stated by the cited source
- **cautions:** Give AFTER the induction agent. JTS ID39: ALWAYS SEDATE PRIOR TO PARALYZING.
- **cautions:** JTS ID40: rocuronium is the choice where succinylcholine is contraindicated — burns, spinal cord injury, hyperkalemia.
- **cautions:** JTS ID40: an increased dose of 1-1.2 mg/kg produces intubating conditions similar to succinylcholine in approximately 60 SECONDS, against succinylcholine's 45.
- **cautions:** JTS ID39 splits by age where the hardcode does not: 1.2 mg/kg adult, 1 mg/kg paediatric.
- **cautions:** The cited guideline states no cumulative maximum for this drug and indication.
...
- **why no value was written:** Rocuronium now HAS a tier-1 source. The hardcode's 1 mg/kg with a 1.2 ceiling sits inside JTS ID40's 1-1.2 mg/kg band, so it is not contradicted — but JTS ID39 makes it age-dependent (1.2 adult, 1.0 paediatric), which the single combined adult|peds entry cannot express. That is the thing to adjudicate: whether this entry splits.
...
**0 of 5 entries live, 0 ready to sign.** class: depolarising neuromuscular blocker · routes: IV, IO
...
- **status:** ⬜ not live — signoff is not true
- **flags:** `MIGRATION_CORROBORATED`, `CONCENTRATION_MISMATCH`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** succinylcholine · RSI paralytic · IV (group `succinylcholine-rsi-adult`)
  - ⚠️ **CONCENTRATION MISMATCH** between the migrated calculator and the WHO-listed strength. A wrong concentration is a wrong volume at the syringe — resolve before signing.
...
- **flags:** `MIGRATED_UNSOURCED`, `CONCENTRATION_MISMATCH`, `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** succinylcholine · RSI paralytic — under 5 years · IV; succinylcholine · RSI paralytic · IV (group `succinylcholine-rsi-peds`)
  - ⚠️ **CONCENTRATION MISMATCH** between the migrated calculator and the WHO-listed strength. A wrong concentration is a wrong volume at the syringe — resolve before signing.
  - ⚠️ **MIGRATED, UNSOURCED.** Value carried over verbatim from the pre-contract hardcode. The engine will NOT let this be signed until a tier 1 or tier 2 citation is attached.
- **dose_range:** `2.0 mg/kg` (per kg)
- **max_single:** none stated by the cited source
...
- **contraindications:** Hyperkalemia
- **cautions:** Contraindicated in hyperkalemia, burns >24hr, crush injury, denervation.
- **cautions:** JTS ID39 gives 1.5 mg/kg for paediatric patients GENERALLY and 2 mg/kg only for those UNDER 5 YEARS. The migrated hardcode applies 2 mg/kg to all paediatric patients.
- **cautions:** JTS ID39: pre-dose atropine in those under 5 receiving succinylcholine, and in anyone receiving a 2nd dose.
- **cautions:** The cited guideline states no maximum single dose for this drug and indication.
- **cautions:** The cited guideline states no cumulative maximum for this drug and indication.
- **source:** tier 1 (NASEMSO) — JTS Clinical Practice Guideline — Airway Management in Trauma, CPG ID39, 28 Jan 2026 — Appendix I — Recommendations for Pediatric Patients, item 4 Neuromuscular blockade, p.28 · retrieved 2026-08-25
...
- **why no value was written:** The hardcode gives 2 mg/kg to EVERY paediatric patient. JTS ID39 gives 2 mg/kg only under 5 years and 1.5 mg/kg otherwise. This is an age-banding disagreement rather than a flat one — for a 7-year-old the hardcode is 33% high against ID39.
...
- **contraindications:** Spinal cord injury
- **contraindications:** Hyperkalemia
- **cautions:** JTS ID40: produces intubating conditions in approximately 45 seconds at this dose.
- **cautions:** JTS ID40 names the contraindications explicitly: burns, spinal cord injury, hyperkalemia — use rocuronium instead in those.
- **cautions:** The cited guideline states no maximum single dose for this drug and indication.
- **cautions:** The cited guideline states no cumulative maximum for this drug and indication.
- **source:** tier 1 (NASEMSO) — JTS Clinical Practice Guideline — Anesthesia for Trauma Patients, CPG ID40, 05 Apr 2021 — Induction of Anesthesia, item 5, p.3 · retrieved 2026-08-25
- **why no value was written:** TIER 1, JTS ID40. Conflicts with JTS ID39's 1.5 mg/kg and with the migrated 1.5 mg/kg.

#### 4. RSI paralytic — under 5 years · peds · IV

- **status:** ⬜ not live — signoff is not true
- **flags:** `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** succinylcholine · RSI paralytic · IV; succinylcholine · RSI paralytic · IV (group `succinylcholine-rsi-peds`)
- **dose_range:** `2.0 mg/kg` (per kg)
- **max_single:** none stated by the cited source
- **max_cumulative:** none stated by the cited source
- **contraindications:** Burns
...
#### 5. RSI paralytic · peds · IV

- **status:** ⬜ not live — signoff is not true
- **flags:** `SOURCE_CONFLICT`
  - ⚠️ **SOURCE CONFLICT — both entries are kept and neither was picked.** Sign the one you adjudicate to and write why in `adjudication`; the engine refuses a signed conflict that has no adjudication note.
  - **conflicts with:** succinylcholine · RSI paralytic · IV; succinylcholine · RSI paralytic — under 5 years · IV (group `succinylcholine-rsi-peds`)
- **dose_range:** `1.5 mg/kg` (per kg)
- **max_single:** none stated by the cited source
- **max_cumulative:** none stated by the cited source
- **contraindications:** Burns
...
**0 of 6 entries live, 4 ready to sign.** class: benzodiazepine · routes: IV, IO, IM, IN
