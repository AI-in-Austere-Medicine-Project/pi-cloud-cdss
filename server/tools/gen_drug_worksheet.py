...
actually requires. Re-run after every authoring pass:
    ...
    cd server && python3 tools/gen_drug_worksheet.py
...
OUT = (pathlib.Path(__file__).resolve().parent.parent.parent
       / "docs" / "authoring" / "DRUG_CONTRACT_WORKSHEET.md")
...
def main():
    ...
    L.append("")
    L.append("Generated by `server/tools/gen_drug_worksheet.py` from "
    ...
    L.append("")
    L.append("Sign with `python3 tools/set_concentration.py --drug X --sign "
